...
public class TSQL2ResultSetMetaData implements ResultSetMetaData, Constants {
	...
	public TSQL2ResultSetMetaData(ResultSetMetaData originalMetaData)
		...
		_indexMap = new ArrayList<Integer>(originalColumnCount);
		_columnLabels = new ArrayList<String>(originalColumnCount);
		_columnNames = new ArrayList<String>(originalColumnCount);
		_columnTypes = new ArrayList<Integer>(originalColumnCount);
		_columnTSQLTypes = new ArrayList<TSQL2Types>(originalColumnCount);
		_columnScales = new ArrayList<DateTimeScale>(originalColumnCount);
		_labelToIndexMap = new HashMap<String, Integer>(originalColumnCount);
	 ...
	 * @param newIndex New index value. This is value after result pre-processing.
	...
	/**
	 * Get inner TSQL type of column.
	 * If column is period, current and next column in original result set are beginning and end of that period.
