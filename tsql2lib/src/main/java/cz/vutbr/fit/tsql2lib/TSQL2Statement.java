...
public class TSQL2Statement implements Statement {
     ...
     */
    private final TSQL2Adapter con;
    /**
     * Parser for statements.
     */
    protected TSQL2ParserAdapter parser;
    /**
     * Locally stored ResultSet. This is used to store result set right after
     * statement execution to allow temporal data cleaning.
     */
    protected TSQL2ResultSet _results = null;
    /**
     * If this is set to true, temporal data used for statement are cleared
     * right after statement execution. If this is false, clear() method must be
     * called manually.
     */
     ...
     */
    private final ArrayList<String> _batch = new ArrayList<>();
    ...
    /**
     * Get statement parse tree string representation. This method is ONLY for
