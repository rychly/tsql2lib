...
/**
 * This class implements JDBC Connection interface and serves as adapter for any
 * other JDBC Connection instance. It adds TSQL2 support to normal relational
 * database represented by that Connection instance.
 *
...
public class TSQL2Adapter implements Connection {
    ...
    /**
     * If this is true, calling close() closes also underlying connection. If
     * this is false, underlying connection remains opened.
     */
    public static boolean closeUnderlyingConnection = true;

    /**
     * Get underlying connection object. This method is for development purposes
     * ONLY and should NOT be used in production environment.
     *
