...
/**
 * This class represents translated intersection of two periods.
 * It contains beginning and end of intersection as string SQL expressions.
 * These values are then used in SQL statement to get intersection boundaries.
 * 
 * @package     cz.vutbr.fit.tsql2lib
