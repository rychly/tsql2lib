...
/**
 * Class containing settings for TSQL2 library.
 * This class contains various values that can be changed to modify library default settings.
 * These values are system table names and quoting characters.
 * Settings are automatically initialized for used database system as required.
 * 
 * @package     cz.vutbr.fit.tsql2lib
...
public class Settings {
	/**
	 * Type of currently used database.
	 * This value is set during environment init.
	 */
	...
	/**
	 * Name of temporal specification table.
	 * This table contains description data used by library to perform 
	 * temporal queries.
	 */
	public static String TemporalSpecTableNameRaw = "_TEMPORAL_SPEC";
	/**
	 * Safe version of temporal specification table. 
	 * This is quoted for direct use in queries.
	 */
	public static String TemporalSpecTableName = "";
	/**
	 * Name of surrogate data table.
	 * This table contains definitions and counter for surrogate columns in temporal tables.
	 */
	public static String SurrogateTableNameRaw = "_SURROGATE";
	/**
	 * Safe version of surrogate data table. 
	 * This is quoted for direct use in queries.
	 */
    ...
    /**
     * Safe version of valid time start column name.
     * This is quoted for direct use in queries.
     */
	public static String ValidTimeStartColumnName = "";
	/**
     * Safe version of valid time end column name.
     * This is quoted for direct use in queries.
     */
    ...
    /**
     * Safe version of transaction time start column name.
     * This is quoted for direct use in queries.
     */
    public static String TransactionTimeStartColumnName = "";
    /**
     * Safe version of transaction time end column name.
     * This is quoted for direct use in queries.
     */
    ...
    public static void init(DatabaseType databseType) throws TSQL2Exception {
    	...
    	if (Settings.DatabaseType.equals(cz.vutbr.fit.tsql2lib.DatabaseType.ORACLE)) {
    		// Oracle settings
    		QUOTE = '"';
    		STRING_QUOTE = '\'';
    	} else if (Settings.DatabaseType.equals(cz.vutbr.fit.tsql2lib.DatabaseType.MYSQL)) {
    		// MySQL settings
    		QUOTE = '`';
    		STRING_QUOTE = '\'';
    	} else if (Settings.DatabaseType.equals(cz.vutbr.fit.tsql2lib.DatabaseType.HSQL)) {
    		// HSQL settings
            // @author  	Marek Rychly <rychly@fit.vutbr.cz>
    		QUOTE = '"';
    		STRING_QUOTE = '\'';
