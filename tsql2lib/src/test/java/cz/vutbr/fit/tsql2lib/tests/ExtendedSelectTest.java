...
public class ExtendedSelectTest extends TestCase implements Constants {
	 ...
	 * 
	 * Provede se spojeni pres jmeno, takze Jan Novak ma celkove delsi 
	 * sluzbu (1.1.1995-dnes) nez Pavel Kovar (6.8.1998 - dnes).
	 */
	 ...
	 * 
	 * Vezmou se pacienti podle tabulky diagnoz, kde na sebe navazuji dve diagnozy
	 */
	...
	/**
	 * Vyber pacienty, kteri navstevovali soucasne dva ruzne lekare a kteri lekari to byli a kdy
     *
	 * Spravny vysledek: Alena Adamkova - 6.12.2004-20.12.2004 - Jana Jandova, Petra Kuncova
	 * 
	 * Vezmou se ti pacienti, kteri maji ruzne diagnozy s ruznymi lekari a prekryvajicimy se casy platnosti 
	 */
	 ...
	 * 
	 * Vezmou se ti pacienti, kteri maji dva zaznamy o leku s prekryvajici se platnosti
	 */
